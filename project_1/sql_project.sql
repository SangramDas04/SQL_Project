Q1: Who is the senior most emmployee based on the job title?
...
-- select * from invoice
select c.customer_id,c.first_name,c.last_name,sum(i.total) as Money_Spent from customer as c
join invoice as i
...
Q7: Let us invite the artists who have written the most rock music in our dataset. Write a 
